...
def build_vocab(dataset):
    ...
    json.dump(entid, open(dataset + '/time2ids', 'w'))
...
def candidate_triples(dataset):
    ...
    with open(dataset + '/path_graph', encoding='utf-8') as f:
    # with open(dataset + '/path_graph') as f:
        for line in f:
            line = line.rstrip()
            e1 = line.split('\t')[0]
...
if __name__ == '__main__':
    ...
    combine_vocab('icews-few/relation2ids', 'icews-few/ent2ids', 'icews-few/relation2vec.vec', 'icews-few/entity2vec.vec', 'icews-few/symbol2ids', 'icews-few/symbol2vec.vec')
    # wiki_candidate('Wikidata')

    # freq_rel_triples('WIKI')
    #
    # candidate_triples('WIKI')
