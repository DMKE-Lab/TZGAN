...
def wiki_text_embedding(args, dataname='Wiki-zs'):
    ...
    print('WIKi description vocab size %d' % (len(vocab)))
...
def icews_text_embedding(args, dataname='icews-zs'):
    # read rela_document.txt
    rela2doc = dict()
    with open(data_path + dataname + "/rela_document.txt") as f_doc:
        lines = f_doc.readlines()
    ...
    #Generate NELL description vocabulary
    vocab = get_vocabulary(rela2doc)
    print('ICEWS description vocab size %d' % (len(vocab)))
...
def gdlet_text_embedding(args, dataname='gdlet-zs'):
    # read rela_document.txt
    rela2doc = dict()
    with open(data_path + dataname + "/rela_document.txt") as f_doc:
        lines = f_doc.readlines()
    ...
    #Generate NELL description vocabulary
    vocab = get_vocabulary(rela2doc)
    print('GDLET description vocab size %d' % (len(vocab)))
